...
<head>
    ...
    <link href="<?php echo e(URL::to('/')); ?>/public/../assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo e(URL::to('/')); ?>/public/css/style.css" rel="stylesheet">
    <!-- You can change the theme colors from here -->
    <link href="<?php echo e(URL::to('/')); ?>/public/css/colors/blue.css" id="theme" rel="stylesheet">
        ...
        <div class="col-lg-12 col-xs-12" style="text-align: center;">
          ...
          <?php if(Route::has('login')): ?>
                <div class="top-right links">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>"><button class="register" style="display: inline;">Register</button></a>&nbsp;&nbsp;&nbsp;
                        <a href="<?php echo e(route('login')); ?>"><button class="register" style="display: inline;">Login</button></a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
<!--
   ...
   <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <script src="<?php echo e(URL::to('/')); ?>/public/../assets/plugins/jquery/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="<?php echo e(URL::to('/')); ?>/public/../assets/plugins/bootstrap/js/tether.min.js"></script>
    <script src="<?php echo e(URL::to('/')); ?>/public/../assets/plugins/bootstrap/js/bootstrap.min.js"></script>
    <!-- slimscrollbar scrollbar JavaScript -->
    <script src="<?php echo e(URL::to('/')); ?>/public/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="<?php echo e(URL::to('/')); ?>/public/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="<?php echo e(URL::to('/')); ?>/public/js/sidebarmenu.js"></script>
    <!--stickey kit -->
    <script src="<?php echo e(URL::to('/')); ?>/public/../assets/plugins/sticky-kit-master/dist/sticky-kit.min.js"></script>
    <!--Custom JavaScript -->
    <script src="<?php echo e(URL::to('/')); ?>/public/js/custom.min.js"></script>
</body>
