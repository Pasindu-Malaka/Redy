            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="{{url('new-customer')}}" aria-expanded="false"><i class="mdi mdi-account-check"></i><span class="hide-menu">New Customer</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{url('history')}}" aria-expanded="false"><i class="mdi mdi-table"></i><span class="hide-menu">History</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{url('my-profile')}}" aria-expanded="false"><i class="mdi mdi-emoticon"></i><span class="hide-menu">My profile</span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="{{url('message-settings')}}" aria-expanded="false"><i class="mdi mdi-email"></i><span class="hide-menu">SMS Settings</span></a>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="row" id="page-content">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <form name="new-job" id="new-job" method="post" action="{{url('dashboard/update/'.$job->Id)}}" style="width: 100%;">
                                {{ csrf_field() }}
                            ...
                            <div class="col-lg-4">
                                ...
                                <input class="form-control" style="width: 100%;" required name="Name" id="customer-name" value="{{$job->Name}}" placeholder="Nimal">
                                <br><br>
                                ...
                                <!--
                                    ...
                                    <div class="col-lg-12" id="mobile-number">
                                        <input type="text" required name="Mobile" class="form-control" value="{{$job->Mobile}}" id="phone-number" placeholder="User Name (Mobile)">
                                    </div>
                                </div>
                                <br>
                                <label class="form-label">Work</label><br>
                                <input type="text" class="form-control" name="Work" value="{{$job->Work}}" id="work" placeholder="A Description About Work">
                                <br><br>
                            </div>
                            ...
                            <div class="col-lg-4">
                                ...
                                <input type="Date" required name="Complete_Date" value="{{$job->Complete_Date}}" id="completion-date" class="form-control">
                                <br><br>
                                <label class="form-label">Amount</label><br>
                                <input type="text" class="form-control" value="{{$job->Amount}}" required name="Amount" id="amount" placeholder="LKR Amount">
                                <br><br>

                                <div class="row">
                                    <div class="col-lg-8"></div>
                                    <div class="col-lg-4" id="btn-row">
                                        {{--<button class="btn btn-title" style="background-color: #1c81d9;">Back</button>--}}
                                        {{--&nbsp;&nbsp;&nbsp;--}}
